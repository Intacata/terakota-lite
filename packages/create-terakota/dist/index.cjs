...
var require_command = __commonJS({
  "node_modules/commander/lib/command.js"(exports2) {
    ...
    var process16 = require("node:process");
...
`);
      ...
      help(contextOptions) {
        ...
        let exitCode = process16.exitCode || 0;
    ...
    function patch(fs3) {
      ...
      function patchLchmod(fs4) {
        ...
        fs4.lchmodSync = function(path8, mode) {
          var fd = fs4.openSync(path8, constants4.O_WRONLY | constants4.O_SYMLINK, mode);
          var threw = true;
          var ret;
          try {
      ...
      function patchLutimes(fs4) {
        if (constants4.hasOwnProperty("O_SYMLINK") && fs4.futimes) {
          fs4.lutimes = function(path8, at, mt, cb) {
            fs4.open(path8, constants4.O_SYMLINK, function(er, fd) {
              if (er) {
                if (cb) cb(er);
                return;
              }
          ...
          fs4.lutimesSync = function(path8, at, mt) {
            var fd = fs4.openSync(path8, constants4.O_SYMLINK);
            var ret;
            var threw = true;
            try {
...
function toPascalCase(str) {
  return str.replace(/(?:^|[-_\s])(\w)/g, (_, c3) => c3?.toUpperCase() ?? "");
}
...
async function createProject(config, cliDir) {
  ...
  await import_fs_extra.default.writeFile(
    import_path.default.join(targetDir, ".npmrc"),
    "legacy-peer-deps=true\n",
    "utf-8"
  );
  if (["mui-tailwind", "mui-shadcn", "shadcn", "tailwind"].includes(config.styling)) {
    await import_fs_extra.default.writeFile(
      import_path.default.join(targetDir, "postcss.config.cjs"),
      `module.exports = {
    plugins: {
        tailwindcss: {},
        autoprefixer: {},
...
async function copyAndTransform(src, dest, config) {
  const replacements2 = getReplacements(config);
  ...
  for (const filePath of allFiles) {
    ...
    if (isText) {
      ...
      for (const { from, to } of replacements2) {
...
// src/banner.ts
var TERAKOTA_BANNER = `
${source_default.bold.hex("#1976D2")("  \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2557\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2557\u2588\u2588\u2588\u2588\u2588\u2588\u2557  \u2588\u2588\u2588\u2588\u2588\u2557 \u2588\u2588\u2557  \u2588\u2588\u2557 \u2588\u2588\u2588\u2588\u2588\u2588\u2557 \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2557 \u2588\u2588\u2588\u2588\u2588\u2557 ")}
${source_default.bold.hex("#1565C0")("     \u2588\u2588\u2554\u2550\u2550\u255D\u2588\u2588\u2554\u2550\u2550\u2550\u2550\u255D\u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2557\u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2557\u2588\u2588\u2551 \u2588\u2588\u2554\u255D\u2588\u2588\u2554\u2550\u2550\u2550\u2588\u2588\u2557\u255A\u2550\u2550\u2588\u2588\u2554\u2550\u2550\u255D\u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2557")}
${source_default.bold.hex("#0D47A1")("     \u2588\u2588\u2551   \u2588\u2588\u2588\u2588\u2588\u2557  \u2588\u2588\u2588\u2588\u2588\u2588\u2554\u255D\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2551\u2588\u2588\u2588\u2588\u2588\u2554\u255D \u2588\u2588\u2551   \u2588\u2588\u2551   \u2588\u2588\u2551   \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2551")}
${source_default.bold.hex("#1565C0")("     \u2588\u2588\u2551   \u2588\u2588\u2554\u2550\u2550\u255D  \u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2557\u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2551\u2588\u2588\u2554\u2550\u2588\u2588\u2557 \u2588\u2588\u2551   \u2588\u2588\u2551   \u2588\u2588\u2551   \u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2551")}
${source_default.bold.hex("#1976D2")("     \u2588\u2588\u2551   \u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2557\u2588\u2588\u2551  \u2588\u2588\u2551\u2588\u2588\u2551  \u2588\u2588\u2551\u2588\u2588\u2551  \u2588\u2588\u2557\u255A\u2588\u2588\u2588\u2588\u2588\u2588\u2554\u255D   \u2588\u2588\u2551   \u2588\u2588\u2551  \u2588\u2588\u2551")}
${source_default.dim("     \u255A\u2550\u255D   \u255A\u2550\u2550\u2550\u2550\u2550\u2550\u255D\u255A\u2550\u255D  \u255A\u2550\u255D\u255A\u2550\u255D  \u255A\u2550\u255D\u255A\u2550\u255D  \u255A\u2550\u255D \u255A\u2550\u2550\u2550\u2550\u2550\u255D    \u255A\u2550\u255D   \u255A\u2550\u255D  \u255A\u2550\u255D")}

  ${source_default.bold.white("F O U N D A T I O N")}  ${source_default.dim("v1.1.0 \u2014 Multi-framework. Multi-variant. Instantly buildable.")}
  ${source_default.dim("\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500")}
`;
var DONE_BANNER = (config) => {
  ...
  const electronNote = desktop === "electron" || desktop === "electron-only" ? `
    ${source_default.cyan(`${pm} run dev:electron`)}         ${source_default.dim("(desktop window)")}` : "";
  const installNote = !config.installDeps ? `
    ${source_default.cyan(`${pm} install`)}` : "";
  return `
  ${source_default.bold.green("\u2714 Done!")} ${source_default.bold(projectName)} is ready.

  ${source_default.bold("Next steps:")}
${installNote}
    ${source_default.cyan(`cd ${projectName}`)}
    ${source_default.cyan(`${pm} run ${devCmd}`)}${electronNote}

  ${source_default.bold("What was created:")}
    ${source_default.dim("Framework")}     ${source_default.yellow(framework)}
    ${source_default.dim("Platform")}      ${source_default.yellow(desktop)}
    ${source_default.dim("Layout")}        ${source_default.yellow(frame)}
    ${source_default.dim("State")}         ${source_default.yellow(stateManager)}

  ${source_default.dim("Switch layouts at runtime:")}
    ${source_default.dim('dispatch(setLayoutVariant("sidebar-vertical"))')}

  ${source_default.dim("Docs:    ")} ${source_default.underline("https://foundation.terakota.live")}
  ${source_default.dim("Terakota:")} ${source_default.underline("https://terakota.live")}

  ${source_default.dim("Happy building! \u{1F680}")}
`;
};

// src/index.ts
var __dirname2 = import_path2.default.dirname((0, import_url2.fileURLToPath)(__importMetaUrl));
var CAPABILITIES = {
  vite: {
    fullDashboard: true,
    stateManagers: ["redux"],
  ...
  tanstack: {
    ...
    // MUI 6-based; shadcn+tailwind also works
    platforms: ["web", "pwa"],
...
program.name("create-terakota").description("Create a new Terakota Foundation project").version("1.2.0").argument("[project-name]", "Name of the project to create").option("-t, --template <template>", "Template to use (skips prompts)").option("--no-install", "Skip package installation").option("--no-git", "Skip git initialization").action(async (projectNameArg, opts) => {
  ...
  if (!projectName) {
    ...
    if (typeof err === "string") {
      console.error(source_default.red(`\u2716 ${err}`));
      process.exit(1);
    }
  }
  ...
  if (await import_fs_extra2.default.pathExists(targetDir)) {
    ...
    await import_fs_extra2.default.emptyDir(targetDir);
  }
  const frameworkRes = await (0, import_prompts.default)({
    type: "select",
    name: "framework",
    message: "Choose a framework:",
    choices: [
      { title: `${source_default.yellow("\u26A1")} Vite               ${source_default.dim("\u2014 Full dashboard: MUI 7 + Redux. PWA/Electron ready")}`, value: "vite" },
      { title: `${source_default.gray("\u25C8")} TanStack Router     ${source_default.dim("\u2014 Full dashboard: MUI 6 + Redux. Type-safe SPA routing")}`, value: "tanstack" },
      { title: `${source_default.cyan("\u269B")} CRA                 ${source_default.dim("\u2014 Full dashboard: MUI 7 + Redux. Webpack (legacy)")}`, value: "cra" },
      { title: `${source_default.blue("\u25B2")} Next.js App Router  ${source_default.dim("\u2014 Full dashboard: MUI 7 + Redux. RSC + SSR")}`, value: "next-app" },
      { title: `${source_default.blue("\u25B2")} Next.js Pages Router${source_default.dim("\u2014 Full dashboard: MUI 7 + Redux. Classic Next.js")}`, value: "next-pages" },
      { title: `${source_default.magenta("\u{1F680}")} Astro               ${source_default.dim("\u2014 Basic starter. Full dashboard coming soon")}`, value: "astro" }
    ],
    initial: 0
  }, { onCancel: () => process.exit(0) });
  const framework = frameworkRes.framework;
...
`));
  ...
  if (!caps.fullDashboard) {
    console.log(source_default.yellow(`  \u26A0  This is a basic starter template \u2014 not a full dashboard.
`));
  }
  const allPlatformChoices = [
    { title: `${source_default.green("\u{1F310}")} Web + PWA            ${source_default.dim("\u2014 Installable PWA, service worker, offline ready")}`, value: "pwa" },
    { title: `${source_default.cyan("\u{1F5A5}")}  Web + PWA + Electron  ${source_default.dim("\u2014 Full cross-platform: browser + desktop app")}`, value: "electron" },
    { title: `${source_default.cyan("\u{1F4BB}")} Electron Only         ${source_default.dim("\u2014 Desktop app only, no service worker/PWA")}`, value: "electron-only" },
    { title: `${source_default.dim("\u25CB")}  Web Only              ${source_default.dim("\u2014 Plain web app, no PWA or Electron")}`, value: "web" }
  ];
  const platformChoices = allPlatformChoices.filter((c3) => caps.platforms.includes(c3.value));
  const desktopRes = await (0, import_prompts.default)({
    type: "select",
    name: "desktop",
  ...
  const allStylingChoices = [
    { title: `MUI 7                    ${source_default.dim("\u2014 Material UI components, Emotion, themed")}`, value: "mui" },
    { title: `MUI 7 + Tailwind CSS     ${source_default.dim("\u2014 MUI layout + Tailwind utility classes")}`, value: "mui-tailwind" },
    { title: `MUI 7 + Shadcn + Tailwind${source_default.dim("\u2014 MUI + headless Shadcn components + Tailwind")}`, value: "mui-shadcn" },
    { title: `Shadcn/ui + Tailwind     ${source_default.dim("\u2014 Headless Shadcn components + Tailwind only")}`, value: "shadcn" },
    { title: `Tailwind CSS Only        ${source_default.dim("\u2014 Pure Tailwind, no component library")}`, value: "tailwind" },
    { title: `Bootstrap 5 + MUI 7      ${source_default.dim("\u2014 Bootstrap grid + MUI components")}`, value: "bootstrap-mui" },
    { title: `CSS Modules / Vanilla    ${source_default.dim("\u2014 Scoped CSS modules, no utility framework")}`, value: "css-modules" },
    { title: `MUI 6                    ${source_default.dim("\u2014 Material UI v6, Emotion, themed (Catalina-safe)")}`, value: "mui6" },
    { title: `MUI 6 + Tailwind CSS     ${source_default.dim("\u2014 MUI v6 + Tailwind utility classes (Catalina-safe)")}`, value: "mui6-tailwind" }
  ];
  const stylingChoices = allStylingChoices.filter((c3) => caps.stylingOptions.includes(c3.value)).map((c3) => {
    if (framework === "tanstack") {
      if (c3.value === "mui") return { ...c3, title: `MUI 6                    ${source_default.dim("\u2014 Material UI v6, Emotion, themed")}` };
      if (c3.value === "mui-tailwind") return { ...c3, title: `MUI 6 + Tailwind CSS     ${source_default.dim("\u2014 MUI v6 + Tailwind utility classes")}` };
    }
    return c3;
  });
  const stylingRes = await (0, import_prompts.default)({
    type: "select",
    name: "styling",
  ...
  const langRes = await (0, import_prompts.default)({
    type: "select",
    name: "language",
    message: "Language:",
    choices: [
      { title: `TypeScript ${source_default.dim("(recommended)")}`, value: "typescript" },
      { title: "JavaScript", value: "javascript" }
    ],
    initial: 0
  }, { onCancel: () => process.exit(0) });
  const frameRes = await (0, import_prompts.default)({
    type: "select",
    name: "frame",
    message: "App frame layout:",
    choices: [
      { title: `Vertical Sidebar              ${source_default.dim("\u2014 Left sidebar + TopBar (collapsible/mini-mode)")}`, value: "sidebar-vertical" },
      { title: `Vertical Sidebar + Right Panel${source_default.dim("\u2014 Left sidebar + TopBar + right info/tools panel")}`, value: "sidebar-vertical-right" },
      { title: `Horizontal (Top) Navigation   ${source_default.dim("\u2014 Full-width top nav bar only, no left sidebar")}`, value: "sidebar-horizontal" },
      { title: `Horizontal Nav + Right Panel  ${source_default.dim("\u2014 Top nav + collapsible right panel")}`, value: "sidebar-horizontal-right" },
      { title: `Dual Panel                    ${source_default.dim("\u2014 Left sidebar + persistent right panel")}`, value: "sidebar-dual" },
      { title: `Minimal                       ${source_default.dim("\u2014 Clean header only, content takes full width")}`, value: "minimal" },
      { title: `Minimal + Right Panel         ${source_default.dim("\u2014 Simple header + slide-in right panel")}`, value: "minimal-right" },
      { title: `Tabbed                        ${source_default.dim("\u2014 IDE/browser-style tab bar navigation")}`, value: "tabbed" }
    ],
    initial: 0
  }, { onCancel: () => process.exit(0) });
  console.log(source_default.dim(`  State management: ${source_default.white("Redux Toolkit")} ${source_default.dim("(all full dashboard templates use Redux)")}`));
  const stateManager = "redux";
  const featuresRes = await (0, import_prompts.default)({
    type: "multiselect",
    name: "features",
  ...
  const pmRes = await (0, import_prompts.default)({
    type: "select",
    name: "pm",
  ...
  console.log();
  console.log(source_default.bold("  Your Terakota Foundation project:"));
  console.log();
  console.log(`  ${source_default.dim("Name")}          ${source_default.cyan(config.projectName)}`);
  console.log(`  ${source_default.dim("Framework")}     ${source_default.yellow(config.framework)}${!caps.fullDashboard ? source_default.dim(" (basic starter)") : ""}`);
  console.log(`  ${source_default.dim("Platform")}      ${source_default.yellow(config.desktop)}`);
  console.log(`  ${source_default.dim("Styling")}       ${source_default.yellow(config.styling)}`);
  console.log(`  ${source_default.dim("Language")}      ${source_default.yellow(config.language)}`);
  console.log(`  ${source_default.dim("Layout")}        ${source_default.yellow(config.frame)}`);
  console.log(`  ${source_default.dim("State mgr")}     ${source_default.yellow(config.stateManager)}`);
  console.log(`  ${source_default.dim("Features")}      ${source_default.yellow(config.features.join(", ") || "none")}`);
  console.log(`  ${source_default.dim("Package mgr")}   ${source_default.yellow(config.packageManager)}`);
  console.log();
  const confirmRes = await (0, import_prompts.default)({
    type: "confirm",
    name: "ok",
  ...
  try {
    await createProject(config, __dirname2);
  ...
  if (config.installDeps) {
    ...
    try {
      ...
      const raw = installErr?.stderr || installErr?.message || "";
