...
import { setMobileSidebarOpen, setSidebarOpen } from '~/features/sidebar/sidebarSlice';
...
function VerticalSidebarShell({ children, withRightPanel }: {
    ...
    return (
        <LayoutRoot>
            {/* TopBar — full width, never shifts with the sidebar */}
            <TopBar />
                    ...
                    {sidebarVisible && (
                        <Box
                            ...
                            sx={{
                                ...
                                bgcolor: alpha(muiTheme.palette.common.black, 0.18),
                            }}
                        />
                    )}
                    <Box
                        sx={{
                            ...
                            borderRight: !isRTL ? `1px solid ${muiTheme.palette.divider}` : 'none',
                            borderLeft:  isRTL  ? `1px solid ${muiTheme.palette.divider}` : 'none',
                            boxShadow: sidebarVisible ? muiTheme.shadows[8] : 'none',
                        }}
                    >
                        <Sidebar />
                    </Box>
            ...
            {/* ── Main content — fills full viewport, sidebar overlays ── */}
            <ContentArea>
                <Main>
